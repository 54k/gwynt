...
final class HttpVersion extends AbstractConstant<HttpVersion> {
    ...
    public static final HttpVersion VERSION_10 = pool.valueOf("HTTP/1.0");
    public static final HttpVersion VERSION_11 = pool.valueOf("HTTP/1.1");
    private static final ConstantPool<HttpVersion> pool = new ConstantPool<HttpVersion>() {
        @Override
